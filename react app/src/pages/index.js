...
export default function Home() {
  ...
  useEffect(() => {
    ...
    const questions = {
      ...
      student: [
        "What is the role of a mining head in an organization?",
        "How do you plan and strategize mining operations?",
        "What challenges do mining heads typically face?",
        ...
        {!selectedRole && (
          <div className="text-center p-6">
            ...
            <div className="flex justify-center space-x-4">
              ...
              <button onClick={() => handleRoleSelect("head")} className="bg-purple-500 rounded-lg px-4 py-2 text-white font-semibold focus:outline-none hover:bg-purple-600 transition-colors duration-300">Head</button>
            </div>
          </div>
        )}
